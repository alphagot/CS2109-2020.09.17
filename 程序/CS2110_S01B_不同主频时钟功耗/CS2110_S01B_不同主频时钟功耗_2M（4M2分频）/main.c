...
#define LVD_TIME	       2		//低压报警时间4０ｓ 5*8
...
//	SYS_REG1 = 0x58; 	 //打开看门狗使能，打开低压复位，打开高速振荡器
	SYS_REG1 = 0x58; 	 //打开看门狗使能，打开低压复位，关闭高速振荡器

	SYS_REG3 = 0x10; 
	SYS_REG2 = 0xe2; //系统时钟3分频
	SYS_REG4 = 0x0e;
//	SYS_REG2 = 0x03;
...
//	SYS_REG4 = 0x0c;	 //PWM用高速时钟4分频
	SYS_REG2 = 0xE2;	 //高速时钟2分频，空闲模式
	SYS_REG4 = 0x0E;	 //PWM用高速时钟2分频
//	SYS_REG2 = 0xe0;
//	SYS_REG4 = 0x01;	 //PWM用高速时钟
	LXT_START = 0X00;
//	SYS_REG2  =0x03;
...
//	WDCNTM = 0x38;
//	WDCNTH = 0x00;
	WDCON = 0x00;		//开启看门狗复位功能
	WDCON |= 0x10;	
/*
	OPA1C0 = 0x20;				//模拟电压输出至端口
	OPA1C1 = 0x0F;				//使能OPA1运放
	OPA1MODE = 0x04;			//设置OPA1开环结构
	OPA2C0 = 0x40;				//模拟电压输出至端口
	OPA2C1 = 0x3f;				//0.1VLDO,使能OPA2运放
	OPA2C2 = 0x00;				//设置OPA2开环结构
*/
