...
//	PWM_PERIOD0H = 0x04;							   
	...
	IRED_CTRL = 0x07;		//设置发射电流为125ｍA
	MISC = 0XC0;	  		//pb6复用IRED，pa0复用TXD，pa1复用RXD  
...
/********************************************/
		...
		if(Smoke_Value>=Dark_Value)
		Smoke_Value2 = Smoke_Value - Dark_Value;
		else
		Smoke_Value2 = 0; 
